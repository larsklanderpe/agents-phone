...
These pages document text opt-in, STOP and HELP, and agent-assisted conversations and scheduling. The messaging backend must implement those behaviors; this static repository does not collect consent, send messages, or handle opt-outs. The public privacy contact is `lars.klander@gmail.com`. Provider processing is disclosed by function without making unverified claims about particular vendors or their AI training policies.
